...
export async function seedNotifications(prismaClient, allPosts, allComments, createdLikes, createdDislikes, createdFollows, createdEvents, createdAttendees) {
    if (!prismaClient) {
    ...
    console.log(`Attempting to create ${notificationData.length} notifications...`);
    try {
