...
export async function seedLikesDislikes(prismaClient, createdUsers, createdPosts) {
    const defaultResult = {
        createdLikes: [],
        createdDislikes: [],
    };
    ...
    if (eligibleUsers.length === 0 || eligiblePosts.length === 0) {
        console.log("...Not enough users or posts to generate likes/dislikes. Skipping.");
