    ...
    try {
      ...
      if (response.ok) {
        toast({
          ...
          description: "Your account has been successfully reactivated. You can now log in.",
        });
        ...
        if (loginResult?.error && loginResult.error !== "Invalid username or password") {
          toast({
            title: "Account Reactivated",
            description: "Your account has been reactivated successfully. Please try logging in manually now.",
          });
      ...
      toast({
        title: "Reactivation failed",
        description: "An unexpected error occurred while reactivating your account",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
        ...
        <div className="space-y-4">
          {!isExpired && (
            <div className="rounded-lg bg-blue-50 p-4 dark:bg-blue-950">
              ...
              <p className="text-sm text-blue-700 dark:text-blue-300">
                You can reactivate your account and restore all your data, posts, and connections.
              </p>
            </div>
          )}
          ...
          <div className="rounded-lg bg-orange-50 p-4 dark:bg-orange-950">
            ...
            <p className="text-sm text-orange-700 dark:text-orange-300">
              Create a new account with the same username. All previous data will remain deleted.
            </p>
          </div>
        ...
        <DialogFooter className="flex gap-2">
          ...
          {!isExpired && (
            ...
            >
              ...
              {isLoading && action === "reactivate" ? "Reactivating..." : "Reactivate Account"}
            </Button>
          )}
