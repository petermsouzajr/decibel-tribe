...
import EventDetails from "./Event"; // Component path
...
describe("[Event][Component] EventDetails Display", () => {
  ...
  it("should render event details correctly", async () => {
    render(<EventDetails event={mockEventData} />);
  ...
  it("should handle cancelled event state", async () => {
    ...
    // Act
    render(<EventDetails event={cancelledEventData} />);
  ...
  it("should expand and collapse description", async () => {
    ...
    // Act
    render(<EventDetails event={longDescriptionEventData} />);
