...
- Legacy: `docs/DATING_MASTER_PLAN.md` said “no native app” — **superseded for UI** by this plan. API/backend guidance in that doc may still apply.
...
- [ ] Update `DATING_FEATURE_COMPLETE.md` / master plan status to “UI owned by datingtribe”  
