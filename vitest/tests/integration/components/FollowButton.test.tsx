...
import { useToast } from "@/components/ui/use-toast"; // Corrected alias path
import { FollowerInfo } from "@/lib/types";

// Mock hooks and modules
// vi.mock("@/hooks/useFollowerInfo"); // Remove this mock
vi.mock("@/lib/ky");
// Correct the path and provide a factory
vi.mock("@/components/ui/use-toast", () => ({
  useToast: vi.fn(), // Mock the hook itself
}));

// Mock return value for useToast's inner toast function
...
describe("[Core][Component] FollowButton", () => {
  ...
  beforeEach(() => {
    ...
    // Configure the mocked useToast hook to return the object containing mockToast
